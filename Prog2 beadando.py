...
if teszt<1 or teszt>5000:
    ...
    while x!=teszt+1:
        n=int(input("Adja meg a tábla sorainak számát: "))
        m=int(input("Adja meg a tábla oszlopainak számát: "))
        if n<1 or n>50 or m<1 or m>50:
            print("No")
        else:
            if (n>1 and m>1) and (n%2==0 or m%2==0):
                print(f"A {teszt}-dik esetben: Yes")
            else:
                print(f"A {teszt}-dik esetben: No")
        x=x+1
